...
(function() {
	...
	var ImageLoader = function(options) {
		...
		var ImgLoadHandler = function(e) {
			...
			numactive--;
			if(opts !== undefined && opts.img !== undefined){
				opts.img.onload = null;
				opts.img.onerror = null;
			}

			if (opts !== undefined && opts.callback)  opts.callback.call($this, opts, true, e);
		...
		var ImgErrorHandler = function(e) {
			...
			if (opts !== undefined && opts.callback)  opts.callback.call($this, opts, false, e);
		...
		var SyncCurrFolderToDOM = function() {
			...
			for (; x < entries.length; x++)
			{
				...
				else
				{
					...
					iteminner.setAttribute('entry_id', entries[x].id);
					iteminner.setAttribute('entry_type', (!entries[x].type || entries[x].type === 'file') ? 'file' : 'folder');
