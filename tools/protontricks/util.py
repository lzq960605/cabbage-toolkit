...
WINE_SCRIPT_TEMPLATE = Path("/home/deck/develop/protontricks/data/scripts/wine_launch.sh").read_text(encoding="utf-8")
# WINESERVER_KEEPALIVE_SH_SCRIPT = Path(
#     pkg_resources.resource_filename(
#         "protontricks", "data/scripts/wineserver_keepalive.sh"
#     )
# ).read_text(encoding="utf-8")
WINESERVER_KEEPALIVE_SH_SCRIPT = Path("/home/deck/develop/protontricks/data/scripts/wineserver_keepalive.sh").read_text(encoding="utf-8")
# WINESERVER_KEEPALIVE_BATCH_SCRIPT = Path(
#     pkg_resources.resource_filename(
#         "protontricks", "data/scripts/wineserver_keepalive.bat"
#     )
# ).read_text(encoding="utf-8")
WINESERVER_KEEPALIVE_BATCH_SCRIPT = Path("/home/deck/develop/protontricks/data/scripts/wineserver_keepalive.bat").read_text(encoding="utf-8")
# BWRAP_LAUNCHER_SH_SCRIPT = Path(
#     pkg_resources.resource_filename(
#         "protontricks", "data/scripts/bwrap_launcher.sh"
#     )
# ).read_text(encoding="utf-8")
BWRAP_LAUNCHER_SH_SCRIPT = Path("/home/deck/develop/protontricks/data/scripts/bwrap_launcher.sh").read_text(encoding="utf-8")
...
def run_command(
    ...
    try:
        ...
        print('launcher_process error:', e)
    finally:
